...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((InjectorApplication)getApplication()).getComponent().inject(this);
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                apiServices.getCities().enqueue(new Callback<List<CityDto>>() {
                    @Override
                    public void onResponse(Call<List<CityDto>> call, Response<List<CityDto>> response) {
                        if (response.isSuccessful())
                        {
                            Timber.i("City Data retrieves successful");
                        }
                    }
                    ...
                    public void onFailure(Call<List<CityDto>> call, Throwable t) {
                        ...
                        Timber.i("City Data retrieves  unsuccessful");
                    }
                });
